...
cv_scores = cross_val_score(model_basic, X, y, cv=5, scoring='f1')
print(f"F1-score medio con validación cruzada (Modelo Básico): {cv_scores.mean():.2f}")
...
grid_search = GridSearchCV(estimator=model_basic, param_grid=param_grid, cv=5, scoring='accuracy')
...
# 7. Análisis de Sesgo y Varianza (Curvas de Aprendizaje)
